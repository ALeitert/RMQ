...
{
    return (sizeof(unsigned) << 3) - __builtin_clz((n - 1) | 1);
}

// Returns the ceil of the logarithm base 2 of the given number.
inline unsigned logC(unsigned long n)
{
    return (sizeof(unsigned long) << 3) - __builtin_clzl((n - 1) | 1);
}

// Returns the ceil of the logarithm base 2 of the given number.
inline unsigned logC(unsigned long long n)
{
    return (sizeof(unsigned long long) << 3) - __builtin_clzll((n - 1) | 1);
}
